-- Привлекательность для строительства (Пермь)
...
drop table if exists tmp.tmp_1074_density_grid_2;
create table tmp.tmp_1074_density_grid_2 as
select
	d1.*,
	case 
...
group by
	...
	d1.sum_ipa_ita
;
create index on tmp.tmp_1074_density_grid_2 using gist(geom);
create index on tmp.tmp_1074_density_grid_2(build_density_1km2_ha);
create index on tmp.tmp_1074_density_grid_2(build_density_class);
create index on tmp.tmp_1074_density_grid_2(build_density_type);
create index on tmp.tmp_1074_density_grid_2(build_density_score);
create index on tmp.tmp_1074_density_grid_2(ipa);
create index on tmp.tmp_1074_density_grid_2(ita);
create index on tmp.tmp_1074_density_grid_2(sum_ipa_ita);
create index on tmp.tmp_1074_density_grid_2(priority);

--create index on tmp.tmp_1074_ita_ipa using gist(geom);
--alter table tmp.tmp_1074_ita_ipa
